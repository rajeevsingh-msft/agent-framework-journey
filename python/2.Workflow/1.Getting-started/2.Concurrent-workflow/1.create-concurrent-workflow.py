...
#https://github.com/microsoft/agent-framework/blob/main/python/samples/getting_started/workflows/parallelism/aggregate_results_of_different_types.py
...
async def main() -> None:
    ...
    try:
        viz.save_svg("concurrent_workflow.svg")
        viz.save_png("concurrent_workflow.png")
        print("✅ Diagrams saved: concurrent_workflow.svg/.png\n")

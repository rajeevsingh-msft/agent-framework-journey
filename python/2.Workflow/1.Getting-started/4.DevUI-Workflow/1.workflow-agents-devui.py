...
#https://github.com/microsoft/agent-framework/blob/main/python/samples/getting_started/devui/workflow_agents/workflow.py
#https://learn.microsoft.com/en-us/agent-framework/user-guide/devui/samples?pivots=programming-language-python
...
# Create Azure OpenAI chat client with DefaultAzureCredential (use 'az login' to authenticate)
